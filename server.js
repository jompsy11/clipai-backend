...
app.post('/api/cut-clip', (req, res) => {
  ...
  // Simple 9:16 conversion — no subtitle filter (avoids libass issues with static ffmpeg)
  const vfFilter = 'scale=1080:1920:force_original_aspect_ratio=decrease,pad=1080:1920:(ow-iw)/2:(oh-ih)/2:black';
